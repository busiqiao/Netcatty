...
const zhCN: Messages = {
  ...
  'terminal.connection.status.connecting': '连接中',
  'terminal.connection.status.authentication': '身份验证',
  'terminal.connection.status.disconnected': '已断开',
  'terminal.connection.chainOf': 'Chain {current} / {total}',
  'terminal.connection.showLogs': '显示日志',
  'terminal.connection.hideLogs': '隐藏日志',
  'terminal.connection.traceLabel': '连接日志',
