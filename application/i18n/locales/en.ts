...
const en: Messages = {
  ...
  'terminal.connection.status.connecting': 'Connecting',
  'terminal.connection.status.authentication': 'Authentication',
  'terminal.connection.status.disconnected': 'Disconnected',
  ...
  'terminal.connection.traceLabel': 'Connection trace',
